      ...
      <div className="mt-4 space-y-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex-1 flex items-center justify-center gap-2 px-4 py-2 bg-purple-500 hover:bg-purple-600 rounded-lg text-white type-body-sm font-semibold transition-colors"
          >
