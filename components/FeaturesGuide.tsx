...
const featureCategories: FeatureCategory[] = [
  {
    ...
    features: [
      ...
      {
        name: 'Smart Guides',
        description: 'Intelligent alignment and snapping system for pixel-perfect designs',
        details: [
          'Real-time element snapping with configurable threshold',
          'Multi-target snapping (edges, centers, spacing, grid)',
          'Alignment tools (left, center, right, top, middle, bottom)',
          'Distribution tools for even horizontal/vertical spacing',
          'Ruler guides with manual placement',
          'Visual overlays showing spacing indicators',
      ...
      {
        name: 'Auto-Layout',
        description: 'Intelligent automatic layout system for responsive designs',
        details: [
          'Automatic element arrangement and spacing',
          'Flexible container layouts (row, column, grid)',
          'Responsive breakpoint support',
          'Smart padding and gap management',
  ...
  },
  {
    ...
    icon: 'fa-video',
    description: 'AI-powered video creation, editing, and animation tools',
    color: '#ec4899',
    features: [
      {
        name: 'Animation Timeline',
        description: 'Professional keyframe-based animation system with advanced easing',
        details: [
          'Multi-track timeline with keyframe editing',
          '20+ easing functions (linear, ease-in/out, bounce, elastic, spring)',
          'Animate position, scale, rotation, opacity, and colors',
          'Playback controls (play, pause, stop, seek, loop)',
          '9 pre-built animation presets (fade-in, slide-in, bounce, shake, pulse)',
          'CSS export for standalone animation code',
          'Visual timeline with draggable keyframes',
          'Time ruler with clickable seek',
        ],
        isNew: true,
        shortcut: 'Ctrl+T',
      },
    ...
    features: [
      {
        ...
        description: 'Intelligent template generation and customization powered by AI',
        details: [
          'AI-powered template generation from text prompts',
          'Smart template recommendations based on project context',
          'Automatic style matching and consistency',
      ...
      {
        name: 'Intelligent Asset Recommendations',
        description: 'AI-powered asset suggestions based on your design context',
        details: [
          'Context-aware asset recommendations',
          'Smart search with semantic understanding',
          'Color-based asset matching',
          'Style consistency suggestions',
          'Usage analytics and trending assets',
      ...
      },
      {
        ...
        description: 'Professional-grade AI-powered image enhancement with 12+ enhancement types',
        details: [
          'Auto-enhance with one-click optimization',
          'Background removal with edge refinement',
          'Upscale images up to 4x resolution',
          'Denoise for cleaner, sharper images',
          'Color correction and white balance',
          'Smart sharpening and detail enhancement',
          'HDR effects and exposure optimization',
          'Style transfer with 6 artistic presets',
          'Object removal and portrait enhancement',
          'Batch processing with queue management',
          'Before/after comparison slider',
          'Export history with re-enhancement options',
        ],
        isNew: true,
        shortcut: 'Ctrl+E',
      },
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Comprehensive version control with visual comparison',
        details: [
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Collaborative feedback system with canvas-pinned comments and annotations',
        details: [
          'Pin comments directly on canvas elements',
          'Multiple annotation types (point, area, arrow, text)',
          ...
          'Filter by status, priority, author, or tags',
          'Keyboard shortcut Ctrl+/ for quick comment',
          'Comment statistics and analytics dashboard',
        ],
        isNew: true,
        shortcut: 'Ctrl+/',
      },
  ...
  },
  {
    ...
    title: 'Export & Share',
    icon: 'fa-share-nodes',
    description: 'Share your work across platforms with powerful export tools',
    color: '#06b6d4',
    features: [
      {
        name: 'Unified Export Pipeline',
        description: 'Comprehensive export system with multiple formats and presets',
        details: [
          'Multi-format export (PNG, JPG, SVG, PDF, WebP, AVIF)',
          'Batch export with queue management',
          'Custom export presets for social media platforms',
      ...
      {
        name: 'Design Handoff',
        description: 'Developer-ready design specifications and code generation',
        details: [
          'Auto-generated CSS/SCSS code snippets',
          'Design token extraction',
          'Spacing and sizing specifications',
          'Color palette export with variables',
  ...
  },
  {
    ...
    features: [
      {
        name: 'Offline Mode',
        description: 'Full offline support with intelligent sync and caching',
        details: [
          'IndexedDB storage for projects and assets',
          'Sync queue with automatic retry and conflict resolution',
          'Network detection with connection quality metrics',
          'Resource caching with multiple strategies (cache-first, network-first)',
          'Storage quota monitoring and management',
          'Data compression for efficient storage',
          'Offline project management panel',
  ...
  },
  {
    ...
    title: 'Design System',
    icon: 'fa-layer-group',
    description: 'Professional design system tools for consistency and scalability',
    color: '#14b8a6',
    features: [
      {
        name: 'Design Tokens',
        description: 'Centralized design tokens for consistent styling across projects',
        details: [
          'Color tokens with semantic naming (primary, secondary, accent)',
          'Typography tokens (font families, sizes, weights, line heights)',
          'Spacing tokens with configurable scale',
          'Shadow and border radius tokens',
          'Animation tokens (duration, easing)',
          'Token export to CSS, SCSS, JSON, Tailwind config',
          'Token inheritance and theming support',
      ...
      },
      {
        ...
        description: 'Reusable component library with variants and documentation',
        details: [
      ...
      },
      {
        ...
        description: 'WCAG 2.1 compliance checker with auto-fix suggestions',
        details: [
          ...
          'Accessibility score and detailed reports',
        ],
        isNew: true,
      },
    ],
  },
  {
    ...
    title: 'Plugin System',
    icon: 'fa-puzzle-piece',
    description: 'Extend functionality with a powerful plugin ecosystem',
    color: '#a855f7',
    features: [
      {
        name: 'Plugin Store',
        description: 'Discover and install plugins from the curated marketplace',
        details: [
          'Featured and popular plugin discovery',
          'Category-based browsing (Design, AI, Export, Integration)',
          'Search with tags and keywords',
          'Rating and download statistics',
          'Verified publisher badges',
          'Free and premium plugin options',
          'Plugin screenshots and changelogs',
        ],
        isNew: true,
      },
      {
        name: 'Plugin Management',
        description: 'Full lifecycle management for installed plugins',
        details: [
          'One-click install and uninstall',
          'Enable/disable plugins without uninstalling',
          'Automatic update checking and notifications',
          'Per-plugin settings configuration',
          'Plugin error logging and debugging',
      ...
      },
      {
        ...
        description: 'Permission-based security model for safe plugin usage',
        details: [
          'Granular permission system (canvas, assets, network, storage)',
          'Risk level indicators for permissions',
          'Sandboxed plugin execution',
          'Third-party plugin controls',
          'Plugin API with secure boundaries',
        ],
        isNew: true,
      },
      {
        name: 'Sample Plugins',
        description: 'Pre-built plugins to extend your workflow',
        details: [
          'Color Palette Generator - AI-powered color suggestions',
          'Figma Import - Import designs from Figma files',
          'AI Layout Assistant - Smart layout recommendations',
          'Icon Library Pro - 50,000+ searchable icons',
          'Enhanced Export - Batch export and cloud upload',
          'Motion Toolkit - Animation presets and easing curves',
          'WCAG Checker - Comprehensive accessibility testing',
          'Code Generator - Export to React, Vue, HTML/CSS',
        ],
        isNew: true,
      },
    ],
  },
  {
    ...
    title: 'Enterprise',
    icon: 'fa-building',
    description: 'Enterprise-grade features for teams, security, and compliance',
    color: '#059669',
    features: [
      {
        name: 'Team Workspaces',
        description: 'Dedicated team spaces with shared assets, projects, and unified permissions',
        details: [
          ...
          'Shared asset library across workspace members',
          'Workspace-level folder organization',
          'Storage quota management per workspace',
          'Transfer ownership and manage member roles',
      ...
      },
      {
        ...
        description: 'Multi-stage review and approval process before publishing designs',
        details: [
          'Create custom approval workflow templates',
          'Multi-stage approval with sequential or parallel reviewers',
          'Auto-assign reviewers based on project type',
          'Approval, rejection, and revision request actions',
          'Threaded comments and feedback on submissions',
      ...
      {
        name: 'Audit Logs',
        description: 'Comprehensive action tracking for compliance and security monitoring',
        details: [
          'Track all user actions across the platform',
          'Detailed event logging (create, update, delete, access, export)',
          'User attribution with IP address and device info',
          'Risk level indicators (low, medium, high, critical)',
          'Advanced filtering by action type, user, date, resource',
          'Export logs to CSV or JSON for compliance reports',
          'Configurable retention policies',
          'Security alerts for suspicious activity',
          'Activity statistics and trend analysis',
        ],
        isNew: true,
        isPro: true,
      },
      {
        ...
        description: 'Enterprise single sign-on with SAML 2.0 and OpenID Connect support',
        details: [
          'SAML 2.0 and OpenID Connect (OIDC) protocols',
          'Pre-configured providers: Okta, Azure AD, Google, OneLogin, Auth0',
          'Custom identity provider configuration',
          'Domain verification with DNS TXT records',
          'Enforce SSO-only authentication for organization',
          'Just-in-time user provisioning',
          'Automatic role mapping from identity provider',
          'Session management and forced logout',
          'Domain allowlist for additional security',
        ],
        isNew: true,
        isPro: true,
      },
      {
        name: 'White-labeling',
        description: 'Complete branding customization for agencies and enterprises',
        details: [
          'Custom logo (full and icon variants)',
          'Brand color palette for light and dark modes',
          'Custom typography and font selection',
          'Custom domain mapping with SSL certificates',
          'Branded login page and email templates',
          'Remove Lumina Studio branding entirely',
          'Custom favicon and meta tags',
          'Inject custom CSS and JavaScript',
          'Analytics integration (Google Analytics, custom)',
          'Custom footer links and support URLs',
        ],
        isNew: true,
        isPro: true,
      },
  ...
  },
  {
    ...
    title: 'Assets & Media',
    icon: 'fa-images',
    description: 'Access millions of professional assets for your designs',
    color: '#0ea5e9',
    features: [
      {
        name: 'Stock Photo Integration',
        description: 'Search and use photos from Unsplash, Pexels, and Pixabay directly in your designs',
        details: [
          'Multi-provider search (Unsplash, Pexels, Pixabay)',
          '12 curated categories (Nature, Business, Technology, People, etc.)',
          'Advanced filters (orientation, color, safe search)',
          'Trending searches and popular categories',
          'One-click add to canvas or download',
          'Favorites collection with custom tags',
          'Download history with usage tracking',
          'Automatic attribution generation',
          'Photo detail modal with metadata',
          'Responsive image size selection (thumbnail to original)',
      ...
      {
        name: 'Asset Library',
        description: 'Centralized library for all your uploaded and generated assets',
        details: [
      ...
      },
      {
        ...
        description: 'Automatic optimization for web-ready assets',
        details: [
