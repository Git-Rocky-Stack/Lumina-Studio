        ...
        `}>
          ...
          <div className="py-1">
            ...
            >
              ...
              <span className="type-body-sm font-semibold text-slate-700">Dashboard</span>
            </button>
            ...
            >
              ...
              <span className="type-body-sm font-semibold text-slate-700">User Guide</span>
            </button>
            ...
            >
              ...
              <span className="type-body-sm font-semibold text-slate-700 group-hover:text-red-600 transition-colors">Sign Out</span>
            </button>
          </div>
        </div>
      )}
